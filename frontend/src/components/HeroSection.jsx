  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl mx-auto text-center px-6">
        ...
        {/* CTA buttons */}
        <motion.div {...fadeUp(0.45)} className="flex justify-center mb-10 sm:mb-16 w-full px-4">
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 p-3 sm:p-3 rounded-3xl sm:rounded-full bg-black/45 border border-[#c9a84c]/20 shadow-2xl shadow-black/40 backdrop-blur-md w-full max-w-sm sm:max-w-none sm:w-auto">
            <a
              href="#showcase"
              className="w-full sm:w-auto group inline-flex items-center justify-center min-w-[178px] px-8 py-3.5 rounded-full bg-gradient-to-r from-[#c9a84c] to-[#e8c547] text-[#0a0a0f] font-bold text-sm tracking-wide shadow-lg shadow-[#c9a84c]/20 hover:shadow-xl hover:shadow-[#c9a84c]/30 hover:-translate-y-0.5 transition-all duration-300"
            >
              Explore System
            ...
            <a
              href="#features"
              className="w-full sm:w-auto inline-flex items-center justify-center min-w-[156px] px-8 py-3.5 rounded-full bg-white/10 border border-white/20 text-white font-semibold text-sm tracking-wide hover:bg-white/15 hover:border-white/30 transition-all duration-300"
            >
              Learn More
            </a>
          </div>
        ...
        <motion.div
          {...fadeUp(0.6)}
          className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-6 sm:gap-12 md:gap-16 px-4 w-full"
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#c9a84c] to-[#e8c547] bg-clip-text text-transparent">
                {stat.value}
              </div>
              <div className="text-xs text-[#8a8480] mt-1 tracking-wider uppercase">
                {stat.label}
              </div>
            </div>
          ))}
