    ...
    >
      <div className="layout-container">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          {/* ── Desktop Nav Links + Login (all right-aligned, equal gap) ── */}
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a
              href="#login"
              className="inline-flex items-center justify-center gap-2.5 min-w-[140px] px-7 py-3 rounded-full bg-white/10 border border-white/20 text-white font-bold text-sm tracking-wide hover:bg-white/15 hover:border-white/30 hover:-translate-y-0.5 transition-all duration-200"
            >
          ...
          >
            <div className="layout-container py-4 flex flex-col gap-1">
              ...
              <a
                href="#login"
                onClick={() => setMenuOpen(false)}
                className="mt-3 px-6 py-3.5 rounded-full text-center bg-white/10 border border-white/20 text-white font-bold text-sm"
              >
                Login
              </a>
            </div>
